        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('variation_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.variations.index") }}" class="nav-link {{ request()->is("admin/variations") || request()->is("admin/variations/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fab fa-google-wallet">
                ...
                @can('shipping_address_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.shipping-addresses.index") }}" class="nav-link {{ request()->is("admin/shipping-addresses") || request()->is("admin/shipping-addresses/*") ? "active" : "" }}">
                ...
                @can('client_list_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.client-lists.index") }}" class="nav-link {{ request()->is("admin/client-lists") || request()->is("admin/client-lists/*") ? "active" : "" }}">
